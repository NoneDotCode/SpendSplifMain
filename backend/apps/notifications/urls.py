...
from backend.apps.notifications.views import NotificationList, HowManyUnseen, UpdateSeen, SimulateNotification, AllSeen
...
urlpatterns = [
    ...
    path("notifications/seen_all/", AllSeen.as_view(), name="all_seen")
]
