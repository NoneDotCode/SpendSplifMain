...
class GoalTransferStatisticView(generics.ListAPIView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        for period, period_transfers in periods.items():
            ...
            percentages = self.get_percentages(period_transfers)  # Передаем period_transfers
...
class IncomeAutoDataView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        income_data = [
            ...
            'account': account_json, 'created': datetime(2025, 3, 24), 'comment': '', 'new_balance': 1034},
            {'amount': 100, 'amount_in_default_currency': 100, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 3, 23), 'comment': '', 'new_balance': 10245},
            {'amount': 1500, 'amount_in_default_currency': 1500, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 3, 21), 'comment': '', 'new_balance': 1034},
            {'amount': 100, 'amount_in_default_currency': 100, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 3, 20), 'comment': '', 'new_balance': 10245},
            {'amount': 750, 'amount_in_default_currency': 750, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 3, 18), 'comment': '', 'new_balance': 14},
            {'amount': 1500, 'amount_in_default_currency': 1500, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 3, 10), 'comment': '', 'new_balance': 1034},
            {'amount': 50, 'amount_in_default_currency': 50, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 3, 1), 'comment': '', 'new_balance': 901},
            {'amount': 1000, 'amount_in_default_currency': 1000, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 2, 27), 'comment': '', 'new_balance': 700},
            {'amount': 1900, 'amount_in_default_currency': 1900, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 2, 21), 'comment': '', 'new_balance': 1039},
            {'amount': 500, 'amount_in_default_currency': 500, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 2, 12), 'comment': '', 'new_balance': 2000},
            {'amount': 390, 'amount_in_default_currency': 390, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 2, 9), 'comment': '', 'new_balance': 3256},
            {'amount': 1500, 'amount_in_default_currency': 1500, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 1, 26), 'comment': '', 'new_balance': 901},
            {'amount': 100, 'amount_in_default_currency': 100, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 1, 17), 'comment': '', 'new_balance': 941},
            {'amount': 750, 'amount_in_default_currency': 750, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 1, 12), 'comment': '', 'new_balance': 23456},
            {'amount': 1500, 'amount_in_default_currency': 1500, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 1, 5), 'comment': '', 'new_balance': 9344},
            {'amount': 50, 'amount_in_default_currency': 50, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2025, 1, 1), 'comment': '', 'new_balance': 901},
            {'amount': 1000, 'amount_in_default_currency': 1000, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 12, 25), 'comment': '', 'new_balance': 601},
            {'amount': 1900, 'amount_in_default_currency': 1900, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 12, 10), 'comment': '', 'new_balance': 941},
            {'amount': 500, 'amount_in_default_currency': 500, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 11, 5), 'comment': '', 'new_balance': 546},
            {'amount': 390, 'amount_in_default_currency': 390, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 10, 18), 'comment': '', 'new_balance': 9023},
            {'amount': 1000, 'amount_in_default_currency': 1000, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 9, 7), 'comment': '', 'new_balance': 901},
            {'amount': 2000, 'amount_in_default_currency': 2000, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 8, 1), 'comment': '', 'new_balance': 101},
            {'amount': 300, 'amount_in_default_currency': 300, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 7, 22), 'comment': '', 'new_balance': 9781},
            {'amount': 900, 'amount_in_default_currency': 900, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 6, 15), 'comment': '', 'new_balance': 9011},
            {'amount': 10000, 'amount_in_default_currency': 10000, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 5, 1), 'comment': '', 'new_balance': 2301},
            {'amount': 1000, 'amount_in_default_currency': 100, 'father_space': father_space, 'currency': 'USD',
            'account': account_json, 'created': datetime(2024, 4, 15), 'comment': '', 'new_balance': 911}
        ]
...
class ExpenseAutoDataView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        categories_json2 = {
            ...
            for name, category in categories2.items()
        }
        ...
        categories_json3 = {
            ...
            for name, category in categories3.items()
        }
        ...
        },
        {
            ...
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2025, 3, 23),
            'comment': '',
            'to_cat': categories_json2['Home'],
            'new_balance': 901
        },
        {
            'amount': 750,
            ...
            'periodic_expense': True,
            'from_acc': account_json,
            'created': datetime(2025, 3, 21),
            'comment': '',
            'to_cat': categories_json3['Food'],
            'new_balance': 10000
        },
        {
            'amount': 1000,
            ...
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2025, 3, 20),
            'comment': '',
            'to_cat': categories_json3['Home'],
            'new_balance': 901
        },
        {
            'amount': 2000,
            'amount_in_default_currency': 2000,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2025, 3, 18),
            'comment': '',
            'to_cat': categories_json['Food'],
            'new_balance': 9011
        },
        ...
        {
            'amount': 100,
            'amount_in_default_currency': 100,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2025, 2, 9),
            'comment': '',
            'to_cat': categories_json['Food'],
            'new_balance': 9012
        },
        ...
        },
        {
            ...
            'periodic_expense': True,
            'from_acc': account_json,
            'created': datetime(2025, 1, 17),
            'comment': '',
            'to_cat': categories_json2['Food'],
            'new_balance': 9349
        },
        {
            'amount': 1000,
        ...
        },
        {
            ...
            'comment': '',
            'to_cat': categories_json2['Utilities'],
            'new_balance': 1000
        },
        {
            'amount': 750,
            ...
            'comment': '',
            'to_cat': categories_json['Subscription'],
            'new_balance': 100
        },
        {
            'amount': 750,
            ...
            'comment': '',
            'to_cat': categories_json['Insurance'],
            'new_balance': 10
        },
        {
            'amount': 750,
            ...
            'comment': '',
            'to_cat': categories_json['Transportation'],
            'new_balance': 10000
        },
        {
            'amount': 750,
        ...
        {
            'amount': 50,
            'amount_in_default_currency': 50,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2024, 2, 1),
            'comment': '',
            'to_cat': categories_json2['Entertainment'],
            'new_balance': 555
        },
        {
            'amount': 75,
            'amount_in_default_currency': 75,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2024, 1, 1),
            'comment': '',
            'to_cat': categories_json2['Transportation'],
            'new_balance': 10085
        },
        {
            'amount': 120,
            'amount_in_default_currency': 120,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2024, 12, 1),
            'comment': '',
            'to_cat': categories_json['Health'],
            'new_balance': 6565
        },
        {
            'amount': 200,
            'amount_in_default_currency': 200,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2024, 11, 1),
            'comment': '',
            'to_cat': categories_json['Gifts'],
            'new_balance': 19896
        },
        {
            'amount': 80,
            'amount_in_default_currency': 80,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2024, 10, 1),
            'comment': '',
            'to_cat': categories_json['Education'],
            'new_balance': 854
        },
        {
            'amount': 300,
            'amount_in_default_currency': 300,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2024, 9, 1),
            'comment': '',
            'to_cat': categories_json['Entertainment'],
            'new_balance': 858
        },
        {
            'amount': 120,
            ...
            'comment': '',
            'to_cat': categories_json3['Gifts'],
            'new_balance': 11
        },
        {
            'amount': 60,
            'amount_in_default_currency': 60,
            'father_space': father_space,
            'currency': 'USD',
            'from_acc': account_json,
            'created': datetime(2024, 7, 1),
        ...
        {
            'amount': 25,
            'amount_in_default_currency': 25,
            'father_space': father_space,
            'currency': 'USD',
            'periodic_expense': True,
            'from_acc': account_json,
            'created': datetime(2024, 6, 1),
            'comment': 'Еженедельная подписка',
            'to_cat': categories_json['Subscription'],
            'new_balance': 555
        },
        {
            ...
            'from_acc': account_json,
            'created': datetime(2024, 5, 1),
            'comment': 'Годовая страховка авто',
            'to_cat': categories_json['Insurance'],
            'new_balance': 135
        },
        {
            ...
            'from_acc': account_json,
            'created': datetime(2024, 4, 1),
            'comment': 'Квартальная арендная плата',
            'to_cat': categories_json['Rent'],
            'new_balance': 4685
        },
        {
            'amount': 300,
            ...
            'from_acc': account_json,
            'created': datetime(2024, 3, 1),
            'comment': 'Полугодовая плата за обучение',
            'to_cat': categories_json['Education'],
            'new_balance': 88
        },
        {
            'amount': 40,
            'amount_in_default_currency': 40,
            'father_space': father_space,
            'currency': 'USD',
            'periodic_expense': True,
            'from_acc': account_json,
            'created': datetime(2024, 2, 1),
            'comment': 'Еженедельные расходы на транспорт',
            'to_cat': categories_json['Transportation'],
            'new_balance': 444
        },
        {
            'amount': 1500,
            'amount_in_default_currency': 1500,
            'father_space': father_space,
            'currency': 'USD',
            'periodic_expense': True,
            'from_acc': account_json,
            'created': datetime(2024, 1, 1),
            'comment': 'Годовая плата за обслуживание',
            'to_cat': categories_json['Maintenance'],
            'new_balance': 55
        }
    ]
...
class TransferAutoDataView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        transfer_data = [
            {'amount': 100, 'amount_in_default_currency': 100, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 3, 24),
             'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 100, 'amount_in_default_currency': 100, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 3, 23), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 150, 'amount_in_default_currency': 150, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 3, 21), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 200, 'amount_in_default_currency': 200, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 3, 20), 'to_goal': goal_main2_data,
            ...
            {'amount': 250, 'amount_in_default_currency': 250, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 3, 18), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 300, 'amount_in_default_currency': 300, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 3, 10), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 400, 'amount_in_default_currency': 400, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 3, 1), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 500, 'amount_in_default_currency': 500, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 2, 27), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 600, 'amount_in_default_currency': 600, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 2, 21), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 700, 'amount_in_default_currency': 700, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 2, 12), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 800, 'amount_in_default_currency': 800, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 2, 9), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 100, 'amount_in_default_currency': 100, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 1, 26), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 150, 'amount_in_default_currency': 150, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 1, 17), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 200, 'amount_in_default_currency': 200, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 1, 12), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 250, 'amount_in_default_currency': 250, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 1, 5), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 300, 'amount_in_default_currency': 300, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2025, 1, 1), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 400, 'amount_in_default_currency': 400, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 12, 25), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 500, 'amount_in_default_currency': 500, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 11, 18), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 600, 'amount_in_default_currency': 600, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 12, 10), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 700, 'amount_in_default_currency': 700, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 11, 7), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 800, 'amount_in_default_currency': 800, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 12, 5), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 900, 'amount_in_default_currency': 900, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 11, 1), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 1000, 'amount_in_default_currency': 1000, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 10, 15), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 1100, 'amount_in_default_currency': 1100, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 10, 22), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 1200, 'amount_in_default_currency': 1200, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 9, 1), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 1300, 'amount_in_default_currency': 1300, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 8, 15), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 1400, 'amount_in_default_currency': 1400, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 7, 1), 'to_goal': goal_main1_data,
             'from_goal': goal_main2_data, 'goal_amount': 4000},
            {'amount': 1500, 'amount_in_default_currency': 1500, 'father_space': father_space, 'currency': 'USD',
            ...
            {'amount': 1700, 'amount_in_default_currency': 1700, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 4, 1), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000},
            {'amount': 1800, 'amount_in_default_currency': 1800, 'father_space': father_space, 'currency': 'USD',
             'from_acc': account_data, 'to_acc': account_data, 'created': datetime(2024, 3, 1), 'to_goal': goal_main2_data,
             'from_goal': goal_main1_data, 'goal_amount': 3000}
        ]
