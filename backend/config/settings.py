...
STRIPE_BUSINESS_PLAN_MONTHLY_PRICE_ID = os.environ.get('STRIPE_BUSINESS_PLAN_MONTHLY_PRICE_ID')
STRIPE_BUSINESS_PLAN_QUARTERLY_PRICE_ID = os.environ.get('STRIPE_BUSINESS_PLAN_QUARTERLY_PRICE_ID')
STRIPE_BUSINESS_PLAN_SEMIANNUALLY_PRICE_ID = os.environ.get('STRIPE_BUSINESS_PLAN_SEMIANNUALLY_PRICE_ID')
STRIPE_BUSINESS_PLAN_YEARLY_PRICE_ID = os.environ.get('STRIPE_BUSINESS_PLAN_YEARLY_PRICE_ID')
...
EMAIL_HOST_USER = "spendsplif@spendsplif.com"
